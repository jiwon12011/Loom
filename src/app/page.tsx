  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-surface">
      ...
      <section className="relative z-10 px-5 pt-3 pb-7">
        <h1 className="text-display font-bold text-text-primary">기억을 검색해보세요</h1>
        <p className="text-body text-text-secondary mt-4">자연어로 검색하면, 관련된 기억을<br />빠르게 찾아드려요</p>
      </section>
      ...
      {query.trim() ? (
        ...
        <div className="relative z-10 text-center py-20 px-8">
          <p className="text-title3 font-bold text-text-primary mb-3">아직 저장된 항목이 없어요</p>
        ...
        <>
          ...
          <section className="relative z-10 px-5 mb-8">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-callout text-text-primary">최근 저장</h2>
          ...
          {frequentItems.some(i => i.copy_count > 0) && (
            <section className="relative z-10 px-5 mb-8">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                  <h2 className="text-callout text-text-primary">자주 복사</h2>

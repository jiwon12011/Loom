...
export default function TabBar() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 z-50 w-full max-w-[430px] -translate-x-1/2 bg-surface/80 backdrop-blur-md border-t border-border-light safe-bottom md:absolute md:left-0 md:translate-x-0">
